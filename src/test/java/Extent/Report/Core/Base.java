...
public class Base {
	...
	public void initialize(String browser) {
		if(browser.equalsIgnoreCase("chrome")) {
			...
			driver.get("http://listsystem.project-demo.info:8071/");
	...
	public void extentReportSpark() throws IOException {
		...
		spark.config().setDocumentTitle("The List System Automation Testing Report");
		spark.config().setReportName("The List System Automation Test Suite");
		...
		extent.setSystemInfo("URL","http://listsystem.project-demo.info:8071/");
		extent.setSystemInfo("Client Name", "Chris");
		extent.setSystemInfo("Time/Zone", "india standard time (Asia/Kolkata)");
		extent.setSystemInfo("Selenium Version", "4.16.1");
		extent.setSystemInfo("Mavan Version", "3.9.4/39.400.20230826-0755");
		extent.setSystemInfo("Java Version", "Java 21");
		extent.setSystemInfo("Browser","Google Chrome");
		extent.setSystemInfo("Test/Report Created By","Mahendra Chauhan");
	}
